...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "🧠", label: "Skill Analysis", path: "/skillAnalysis" },
      { icon: "❤️", label: "Saved", path: "/saved", badge: 7, badgeClass: "green" },
      { icon: "📄", label: "Resume Builder", path: "/resumeBuilder" },
    ],
  },
  {
    label: "Insights",
...
const internships: Internship[] = [
  { id: 1, icon: "🧠", title: "ML Engineer Intern", company: "Google DeepMind", location: "London", mode: "Remote", stipend: "₹85k/mo", match: 96, logoBg: "rgba(0,100,255,0.08)" },
  { id: 2, icon: "☁️", title: "Cloud Solutions Intern", company: "Amazon AWS", location: "Bengaluru", mode: "Hybrid", stipend: "₹60k/mo", match: 91, logoBg: "rgba(255,165,0,0.08)" },
  { id: 3, icon: "📱", title: "iOS Dev Intern", company: "Swiggy", location: "Bengaluru", mode: "On-site", stipend: "₹45k/mo", match: 88, logoBg: "rgba(0,200,150,0.08)" },
  { id: 4, icon: "🤖", title: "AI Research Intern", company: "Microsoft Research", location: "Hyderabad", mode: "Remote", stipend: "₹75k/mo", match: 85, logoBg: "rgba(100,0,255,0.08)" },
  { id: 5, icon: "🛡️", title: "Security Intern", company: "Zerodha", location: "Bengaluru", mode: "Hybrid", stipend: "₹50k/mo", match: 82, logoBg: "rgba(255,20,100,0.08)" },
];
...
export default function InternLinkDashboard(): ReactElement {
  ...
  return (
    <div className="app">
      ...
      {/* ── Sidebar ── */}
       ...
       <div className="logo" onClick={() => handleNav("Dashboard", "/dashboard")} style={{ cursor: "pointer", padding: "0 16px 24px" }}>
      ...
      <div className="sidebar-bottom">
        <div className="user-card" onClick={() => handleNav("My Profile", "/profile")} style={{ cursor: "pointer" }}>
          <div className="avatar">SS</div>
          <div className="user-info">
            <div className="user-name">Siddhant Sonarkar</div>
            <div className="user-role">Comps, 2nd Year</div>
          </div>
  ...
  <main className="main">
    ...
    <div className="header">
      ...
      <div className="header-right">
        ...
        <div
          className="avatar"
          style={{ width: 40, height: 40, cursor: "pointer", fontSize: 14 }}
    ...
    <div className="stats-grid">
      {[
        { cls: "blue", icon: "🎯", val: 247, suffix: "", label: "Total Matches", change: "↑ 18%", changeClass: "up", path: "/recommendations" },
        { cls: "cyan", icon: "📨", val: 14, suffix: "", label: "Applications Sent", change: "↑ 5 this week", changeClass: "up", path: "/applications" },
        { cls: "purple", icon: "💬", val: 6, suffix: "", label: "Interview Calls", change: "↑ 2 new", changeClass: "up", path: "/applications" },
        { cls: "gold", icon: "⭐", val: 87, suffix: "%", label: "Profile Strength", change: "↑ 3%", changeClass: "up", path: "/profile" },
      ].map((s) => (
        <div key={s.label} className={`stat-card ${s.cls}`} onClick={() => navigate(s.path)} style={{ cursor: "pointer" }}>
          ...
          <div
            ...
            style={{
              ...
              ...(s.cls === "blue" || s.cls === "cyan"
                ? { background: "linear-gradient(135deg, var(--accent), var(--accent2))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }
                : {}),
            }}
          >
      ...
      <div className="card">
        <div className="card-header">
          <div>
            <div className="card-title">
              Internship Recommendations <span className="ai-badge">✨ AI Powered</span>
            </div>
        ...
        {internships.map((item) => (
          <div className="internship-item" key={item.id}>
            <div className="company-logo" style={{ background: item.logoBg }}>{item.icon}</div>
          ...
          <div className="gauge-wrap">
            <svg className="gauge-svg" viewBox="0 0 140 80">
              ...
              <path d="M 15 75 A 55 55 0 0 1 125 75" fill="none" stroke="url(#gaugeGrad)" strokeWidth="10" strokeLinecap="round"
                strokeDasharray="173" strokeDashoffset="22"
            ...
            {[
              ...
              <div className="skill-item" key={s.name}>
                ...
                <div className="skill-bar-track">
                  <div className="skill-bar-fill" style={{ width: `${s.pct}%`, background: s.bar }} />
                </div>
    ...
    <div className="bottom-grid">
      ...
      <div className="card">
        ...
        <div>
          {[
            { dot: "blue", icon: "🎯", text: <><strong>Applied to Google DeepMind</strong> ML Intern role</>, time: "2 hours ago", chip: <span className="chip" style={{ background: "rgba(59,130,246,0.1)", borderColor: "rgba(59,130,246,0.2)" }}>Applied</span> },
            { dot: "green", icon: "📄", text: <><strong>Resume updated</strong> — added ML projects</>, time: "Yesterday", chip: null },
            { dot: "gold", icon: "💬", text: <><strong>Interview scheduled</strong> with Amazon AWS</>, time: "Yesterday", chip: <span className="chip" style={{ background: "rgba(251,191,36,0.1)", color: "var(--gold)", borderColor: "rgba(251,191,36,0.2)" }}>🗓</span> },
            { dot: "purple", icon: "⭐", text: <><strong>Saved</strong> Microsoft Research internship</>, time: "2 days ago", chip: null },
            { dot: "blue", icon: "🔔", text: <><strong>New match:</strong> Stripe Backend Intern</>, time: "3 days ago", chip: <span className="chip">93%</span> },
          ].map((a, i) => (
      ...
      <div className="card">
        ...
        {[
          { icon: "🤖", role: "AI Research Intern", company: "Microsoft Research", bg: "rgba(100,0,255,0.08)" },
          { icon: "💳", role: "Backend Intern", company: "Stripe Inc.", bg: "rgba(0,150,255,0.08)" },
          { icon: "🛒", role: "Data Science Intern", company: "Flipkart", bg: "rgba(20,200,100,0.08)" },
          { icon: "🎨", role: "Design Intern", company: "Figma", bg: "rgba(255,100,0,0.08)" },
          { icon: "🧬", role: "DevOps Intern", company: "Razorpay", bg: "rgba(255,0,100,0.08)" },
          { icon: "🔒", role: "Cybersecurity Intern", company: "Palo Alto Networks", bg: "rgba(0,200,200,0.08)" },
        ].map((s) => (
          <div className="saved-item" key={s.role}>
            <div className="saved-logo" style={{ background: s.bg }}>{s.icon}</div>
        ...
        <div style={{ marginTop: 14, padding: 12, borderRadius: 10, background: "rgba(59,130,246,0.06)", border: "1px solid rgba(59,130,246,0.15)" }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: "var(--accent)", marginBottom: 4 }}>✨ AI Tip</div>
