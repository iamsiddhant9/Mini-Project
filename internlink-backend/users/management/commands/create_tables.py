...
class Command(BaseCommand):
    help = "Create all custom SQL tables (users, internships, etc.)"

    def handle(self, *args, **options):
        self.stdout.write("Creating custom tables...")
        ...
        self.stdout.write(self.style.SUCCESS("All custom tables created successfully."))
        ...
        with connection.cursor() as cur:
            cur.execute("""
                ...
                VALUES (%s, %s, 'Admin', 'admin', TRUE, TRUE, TRUE)
                ON CONFLICT (email) DO NOTHING
            """, ["admin@internlink.com", pw_hash])
        self.stdout.write(self.style.SUCCESS("Admin user ready: admin@internlink.com / admin123"))
